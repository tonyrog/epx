...
// 32 bit
#define EPX_FORMAT_R8G8B8A8_BE EPX_BE_FMT(EPX_FMT_RGB8,0,1,0,32)
#define EPX_FORMAT_R8G8B8X8_BE EPX_BE_FMT(EPX_FMT_RGB8,0,0,0,32)
#define EPX_FORMAT_A8R8G8B8_BE EPX_BE_FMT(EPX_FMT_RGB8,0,1,1,32)
#define EPX_FORMAT_X8R8G8B8_BE EPX_BE_FMT(EPX_FMT_RGB8,0,0,1,32)

#define EPX_FORMAT_R8G8B8A8_LE EPX_LE_FMT(EPX_FMT_RGB8,0,1,0,32)
#define EPX_FORMAT_R8G8B8X8_LE EPX_LE_FMT(EPX_FMT_RGB8,0,0,0,32)
#define EPX_FORMAT_A8R8G8B8_LE EPX_LE_FMT(EPX_FMT_RGB8,0,1,1,32)
#define EPX_FORMAT_X8R8G8B8_LE EPX_LE_FMT(EPX_FMT_RGB8,0,0,1,32)

#define EPX_FORMAT_R8G8B8A8 EPX_FORMAT_R8G8B8A8_BE
#define EPX_FORMAT_R8G8B8X8 EPX_FORMAT_R8G8B8X8_BE
#define EPX_FORMAT_A8R8G8B8 EPX_FORMAT_A8R8G8B8_BE
#define EPX_FORMAT_X8R8G8B8 EPX_FORMAT_X8R8G8B8_BE

#define EPX_FORMAT_B8G8R8A8_BE EPX_BE_FMT(EPX_FMT_RGB8,1,1,0,32)
#define EPX_FORMAT_B8G8R8X8_BE EPX_BE_FMT(EPX_FMT_RGB8,1,0,0,32)
#define EPX_FORMAT_A8B8G8R8_BE EPX_BE_FMT(EPX_FMT_RGB8,1,1,1,32)
#define EPX_FORMAT_X8B8G8R8_BE EPX_BE_FMT(EPX_FMT_RGB8,1,0,1,32)

#define EPX_FORMAT_B8G8R8A8_LE EPX_LE_FMT(EPX_FMT_RGB8,1,1,0,32)
#define EPX_FORMAT_B8G8R8X8_LE EPX_LE_FMT(EPX_FMT_RGB8,1,0,0,32)
#define EPX_FORMAT_A8B8G8R8_LE EPX_LE_FMT(EPX_FMT_RGB8,1,1,1,32)
#define EPX_FORMAT_X8B8G8R8_LE EPX_LE_FMT(EPX_FMT_RGB8,1,0,1,32)

#define EPX_FORMAT_B8G8R8A8 EPX_FORMAT_B8G8R8A8_BE
#define EPX_FORMAT_B8G8R8X8 EPX_FORMAT_B8G8R8X8_BE
#define EPX_FORMAT_A8B8G8R8 EPX_FORMAT_A8B8G8R8_BE
#define EPX_FORMAT_X8B8G8R8 EPX_FORMAT_X8B8G8R8_BE

#define EPX_FORMAT_L16A16_BE   EPX_BE_FMT(EPX_FMT_GRAY,0,1,0,32)
#define EPX_FORMAT_A16L16_BE   EPX_BE_FMT(EPX_FMT_GRAY,0,1,1,32)

#define EPX_FORMAT_L16A16  EPX_FORMAT_L16A16_BE
#define EPX_FORMAT_A16L16  EPX_FORMAT_A16L16_BE

#define EPX_FORMAT_A8Y8U8V8_BE EPX_BE_FMT(EPX_FMT_YUV8,0,1,1,32)
#define EPX_FORMAT_X8Y8U8V8_BE EPX_BE_FMT(EPX_FMT_YUV8,0,0,1,32)

#define EPX_FORMAT_A8Y8U8V8_LE EPX_LE_FMT(EPX_FMT_YUV8,0,1,1,32)
#define EPX_FORMAT_X8Y8U8V8_LE EPX_LE_FMT(EPX_FMT_YUV8,0,0,1,32)

#define EPX_FORMAT_A8Y8U8V8 EPX_FORMAT_A8Y8U8V8_BE
#define EPX_FORMAT_X8Y8U8V8 EPX_FORMAT_X8Y8U8V8_BE

#define EPX_FORMAT_A2R10G10B10_BE EPX_BE_FMT(EPX_FMT_RGB10,0,1,0,32)
#define EPX_FORMAT_A2R10G10B10_LE EPX_LE_FMT(EPX_FMT_RGB10,0,1,0,32)
#define EPX_FORMAT_A2R10G10B10 EPX_FORMAT_A2R10G10B10_BE
...
// 16 bit
#define EPX_FORMAT_R5G5B5A1_BE  EPX_BE_FMT(EPX_FMT_RGB5,0,1,0,16)
#define EPX_FORMAT_A1R5G5B5_BE  EPX_BE_FMT(EPX_FMT_RGB5,0,1,1,16)
#define EPX_FORMAT_R5G5B5X1_BE  EPX_BE_FMT(EPX_FMT_RGB5,0,0,0,16)
#define EPX_FORMAT_X1R5G5B5_BE  EPX_BE_FMT(EPX_FMT_RGB5,0,0,1,16)
#define EPX_FORMAT_R5G5B5A1_LE  EPX_LE_FMT(EPX_FMT_RGB5,0,1,0,16)
#define EPX_FORMAT_A1R5G5B5_LE  EPX_LE_FMT(EPX_FMT_RGB5,0,1,1,16)
#define EPX_FORMAT_R5G5B5X1_LE  EPX_LE_FMT(EPX_FMT_RGB5,0,0,0,16)
#define EPX_FORMAT_X1R5G5B5_LE  EPX_LE_FMT(EPX_FMT_RGB5,0,0,1,16)
...
#define EPX_FORMAT_L8A8_BE      EPX_BE_FMT(EPX_FMT_GRAY,0,1,0,16)
#define EPX_FORMAT_A8L8_BE      EPX_BE_FMT(EPX_FMT_GRAY,0,1,1,16)
#define EPX_FORMAT_L16_BE       EPX_BE_FMT(EPX_FMT_GRAY,0,0,0,16)
...
#define EPX_FORMAT_A8           EPX_BE_FMT(EPX_FMT_ALPHA,0,1,1,8)
#define EPX_FORMAT_R8           EPX_BE_FMT(EPX_FMT_RED,0,0,0,8)
#define EPX_FORMAT_G8           EPX_BE_FMT(EPX_FMT_GREEN,0,0,0,8)
#define EPX_FORMAT_B8           EPX_BE_FMT(EPX_FMT_BLUE,0,0,0,8)
...
#define EPX_FORMAT_RGBA   EPX_FORMAT_R8G8B8A8_BE
#define EPX_FORMAT_ARGB   EPX_FORMAT_A8R8G8B8_BE
...
extern char* epx_pixel_format_to_name(epx_format_t fmt,char* buf, size_t size);
